...
const SFX = {
  ...
  cave_drip: ["water softly dripping in an echoing cave", 3.0, true],
  ...
  seagull: ["a seagull crying overhead near the coast", 2.0, false],
  ...
  // 🚀 další doprava
  airplane: ["a small propeller airplane flying overhead, a friendly drone", 2.5, false],
  bicycle_bell: ["a cheerful bicycle bell ringing twice", 1.0, false],
  rocket_launch: ["a toy-like rocket whooshing off with a friendly launch sound", 2.5, false],
  ...
  // 🎈 hry a oslavy
  ball_bounce: ["a ball bouncing on the ground a few times", 1.5, false],
  balloon_pop: ["a single balloon popping playfully, not startling", 1.0, false],
