...
function FairyBackground() {
  return (
    ...
    >
      ...
      <circle cx="450" cy="148" r="0.9" fill="white" opacity="0.6" />
      <circle cx="1002" cy="138" r="1.0" fill="white" opacity="0.65" />
      ...
      {/* Cloud left – purple-pink sunset tint */}
      <g opacity="0.78">
      ...
      {/* Magic path to castle */}
      <path d="M640 900 Q670 858 700 820 Q720 795 740 820 Q765 852 800 900" fill="none" stroke="#f9a825" strokeWidth="3" opacity="0.2" />
