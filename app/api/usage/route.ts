...
// 🩺 2026-08-09: ownUsage vytažena do lib/usage.ts, ať ji může sdílet i
// /api/job/start (MONTHLY_SPEND_CAP_USD pojistka, viz monthToDateGeminiUsd
// tamtéž) — beze změny chování tohohle endpointu, jen jiné umístění kódu.
import { ownUsage } from "@/lib/usage";
