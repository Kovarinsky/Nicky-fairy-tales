...
/**
 * Nickyho pohádky — voice picker screen.
 * Drop /public/images/voice-<id>.png portrait avatars (square, ~200×200).
    ...
    <main className={styles.screen}>
      ...
      {active && (
        <div className={styles.heroText}>
          ...
          <div className={styles.heroSub}>{active.subtitle ?? "Google Gemini TTS"}</div>
        </div>
      )}
...
function Bars() {
  return (
    <span className="voiceBars" style={{ display: "flex", alignItems: "center", gap: 4 }}>
