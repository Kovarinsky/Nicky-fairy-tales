...
function buildSystemPrompt(language: string): string {
  ...
  if (langName) {
    return [
      ...
      "- TEAM SPORTS UNIFORMS (MANDATORY when the story has an official match/competition — football, hockey, etc.): add a 'Team kits:' entry to heroDescription that locks the EXACT kit for the hero's team (shirt color+pattern, shorts, socks, whether it has a number) and, separately, the opponent's kit in CLEARLY DIFFERENT colors — e.g. 'Team kits: Nicolas's team wears a red shirt with white sleeves, white shorts, red socks; opponents wear light-blue-and-white striped shirts, black shorts.' EVERY imagePrompt for a match/training scene must END with which kit is worn: '(Nicolas and teammates in their team kit)' during the match, or '(Nicolas in his everyday clothes, off the pitch)' when the scene is NOT on the pitch — never a mix of team kit and everyday clothes among people on the SAME pitch at the SAME time.",
  ...
  return [
    ...
    "- TÝMOVÉ SPORTOVNÍ DRESY (POVINNÉ, když se v příběhu hraje oficiální zápas/soutěž — fotbal, hokej apod.): přidej do heroDescription záznam 'Team kits:', který zamkne PŘESNÝ dres hrdinova týmu (barva a vzor dresu, trenýrky, štulpny, jestli má číslo) a ZVLÁŠŤ dres soupeře v ZŘETELNĚ jiných barvách (anglicky), např. 'Team kits: Nicolas's team wears a red shirt with white sleeves, white shorts, red socks; opponents wear light-blue-and-white striped shirts, black shorts.' KAŽDÝ imagePrompt pro scénu zápasu/tréninku musí KONČIT tím, který dres postava má: '(Nicolas and teammates in their team kit)' během zápasu, nebo '(Nicolas in his everyday clothes, off the pitch)', když scéna NENÍ na hřišti — nikdy míchanka dresu a civilu mezi lidmi na STEJNÉM hřišti ve STEJNOU chvíli.",
